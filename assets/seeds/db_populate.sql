...
-- DATAS ATUALIZADAS A PARTIR DE 20/10/2025
(11, 'Treino de Férias - Futsal', 'esportivo', 'Futsal', '2025-10-20', 'primeiro', 'Treino leve de manutenção durante as férias.', 'finalizado', 'Lucas Mendes', 15),
(12, 'Jogo Amistoso Vôlei', 'esportivo', 'Voleibol', '2025-10-20', 'segundo', 'Amistoso contra time convidado.', 'finalizado', 'Julia Alves', 20),
(8, 'Curso de Extensão: Programação em R', 'nao_esportivo', NULL, '2025-10-21', 'primeiro', 'Curso de férias para a comunidade.', 'finalizado', 'Profa. Beatriz Lima', 40),
(15, 'Planejamento de Eventos MAGNA', 'nao_esportivo', NULL, '2025-10-21', 'primeiro', 'Reunião de diretoria para o próximo semestre.', 'finalizado', 'Gabriel Pereira', 12),
(11, 'Treino Físico Geral', 'esportivo', 'Atletismo', '2025-10-22', 'segundo', 'Preparação física geral para atletas.', 'finalizado', 'Lucas Mendes', 25),
(20, 'Palestra: Saúde Mental no Esporte', 'nao_esportivo', NULL, '2025-10-22', 'primeiro', 'Palestra com psicólogo convidado.', 'finalizado', 'Sr. Jorge Santos', 80),
(13, 'Campeonato Relâmpago de CS:GO', 'esportivo', 'CS:GO', '2025-10-23', 'segundo', 'Torneio de um dia entre os alunos.', 'finalizado', 'Pedro Martins', 16),
(14, 'Ação Social SANGUINÁRIA', 'nao_esportivo', NULL, '2025-10-23', 'primeiro', 'Campanha de doação de sangue.', 'finalizado', 'Fernanda Oliveira', 100),
(16, 'Treino de Handebol Feminino', 'esportivo', 'Handebol', '2025-10-24', 'segundo', 'Treino técnico e tático.', 'finalizado', 'Mariana Ferreira', 16),
(11, 'Volta aos Treinos - Futsal', 'esportivo', 'Futsal', '2025-10-24', 'primeiro', 'Início oficial dos treinos do semestre.', 'finalizado', 'Lucas Mendes', 18),
(12, 'Seletiva Vôlei PREDADORA', 'esportivo', 'Voleibol', '2025-10-25', 'segundo', 'Seleção de novas atletas.', 'finalizado', 'Julia Alves', 30),
(7, 'Aula Magna Engenharia Civil', 'nao_esportivo', NULL, '2025-10-25', 'primeiro', 'Evento de boas-vindas aos calouros.', 'finalizado', 'Prof. Carlos Andrade', 150),
(13, 'Treino Tático Valorant', 'esportivo', NULL, '2025-10-26', 'segundo', 'Análise de mapas e estratégias.', 'finalizado', 'Pedro Martins', 10),
(16, 'Treino Handebol VENENOSA', 'esportivo', 'Handebol', '2025-10-26', 'primeiro', 'Foco em jogadas ensaiadas.', 'finalizado', 'Mariana Ferreira', 14),
(9, 'Simpósio de Direito Penal', 'nao_esportivo', NULL, '2025-10-27', 'primeiro', 'Evento com palestras e debates.', 'finalizado', 'Prof. Ricardo Souza', 120),
(11, 'Treino de Rugby', 'esportivo', NULL, '2025-10-27', 'segundo', 'Treino de contato e táticas de jogo.', 'finalizado', 'Lucas Mendes', 22),
(17, 'Festival de Queimada', 'esportivo', 'Queimada', '2025-10-28', 'primeiro', 'Evento de integração para calouros.', 'finalizado', 'Bruno Rodrigues', 50),
(4, 'Reunião Geral - Admin Atlética', 'nao_esportivo', NULL, '2025-10-28', 'primeiro', 'Alinhamento com a diretoria de esportes.', 'finalizado', 'Admin Atletica Teste', 8),
(12, 'Treino de Polo Aquático', 'esportivo', NULL, '2025-10-29', 'segundo', 'Treino em piscina olímpica.', 'finalizado', 'Julia Alves', 12),
(14, 'Treino Basquete SANGUINÁRIA', 'esportivo', 'Basquetebol', '2025-10-29', 'primeiro', 'Fundamentos e jogadas.', 'finalizado', 'Fernanda Oliveira', 15),
(7, 'Palestra: Engenharia e Inovação', 'nao_esportivo', NULL, '2025-10-30', 'primeiro', 'Evento do curso de Engenharia de Produção.', 'finalizado', 'Prof. Carlos Andrade', 90),
(11, 'Jogo-Treino Futsal vs SANGUINÁRIA', 'esportivo', 'Futsal', '2025-10-30', 'segundo', 'Jogo preparatório.', 'finalizado', 'Lucas Mendes', 35),
(8, 'Treino de Cobertura de Eventos', 'nao_esportivo', NULL, '2025-10-31', 'primeiro', 'Atividade prática para alunos de Jornalismo.', 'finalizado', 'Profa. Beatriz Lima', 25),
(13, 'Treino Cancelado (Chuva)', 'esportivo', 'League of Legends', '2025-10-31', 'segundo', 'Treino cancelado por problemas na rede elétrica.', 'cancelado', 'Pedro Martins', 8),
(15, 'Semana do Administrador', 'nao_esportivo', NULL, '2025-11-01', 'primeiro', 'Ciclo de palestras e workshops.', 'finalizado', 'Gabriel Pereira', 60),
(12, 'Amistoso Vôlei vs IMPÉRIO', 'esportivo', 'Voleibol', '2025-11-01', 'segundo', 'Jogo amistoso entre atléticas.', 'finalizado', 'Julia Alves', 28),
(16, 'Torneio de Handebol Feminino', 'esportivo', 'Handebol', '2025-11-02', 'primeiro', 'Primeira rodada do torneio interno.', 'finalizado', 'Mariana Ferreira', 32),
(4, 'Manutenção do E-Sports', 'nao_esportivo', NULL, '2025-11-02', 'segundo', 'Atualização dos computadores da sala de e-sports.', 'finalizado', 'Admin Atletica Teste', 5),
(18, 'Cine Debate - Psicologia', 'nao_esportivo', NULL, '2025-11-03', 'primeiro', 'Exibição de filme seguida de debate.', 'finalizado', 'Larissa Gonçalves', 45),
(11, 'Treino Intensivo Futsal', 'esportivo', 'Futsal', '2025-11-03', 'segundo', 'Preparação para o Intercursos.', 'finalizado', 'Lucas Mendes', 20),
(11, 'Treino Futsal Masculino - FURIOSA', 'esportivo', 'Futsal', '2025-11-04', 'primeiro', 'Treino preparatório para o Intercursos.', 'finalizado', 'Lucas Mendes', 20),
(12, 'Treino Vôlei Feminino - PREDADORA', 'esportivo', 'Voleibol', '2025-11-04', 'segundo', 'Treino tático e físico.', 'finalizado', 'Julia Alves', 16),
(13, 'Treino League of Legends - ALFA', 'esportivo', 'League of Legends', '2025-11-05', 'primeiro', 'Treino de estratégias e team play.', 'aprovado', 'Pedro Martins', 10),
(20, 'Palestra sobre Mercado de Trabalho', 'nao_esportivo', NULL, '2025-11-05', 'primeiro', 'Palestra com convidado externo para alunos.', 'aprovado', 'Sr. Jorge Santos', 75),
(14, 'Treino Basquete - SANGUINÁRIA', 'esportivo', 'Basquetebol', '2025-11-06', 'segundo', 'Foco em arremessos e defesa.', 'aprovado', 'Fernanda Oliveira', 12),
(8, 'Workshop de Python para iniciantes', 'nao_esportivo', NULL, '2025-11-06', 'primeiro', 'Organizado pelo curso de Ciência da Computação.', 'aprovado', 'Profa. Beatriz Lima', 30),
(11, 'Amistoso Futsal FURIOSA x ALFA', 'esportivo', 'Futsal', '2025-11-07', 'segundo', 'Jogo amistoso entre as atléticas.', 'aprovado', 'Lucas Mendes', 40),
(15, 'Reunião da Atlética MAGNA', 'nao_esportivo', NULL, '2025-11-07', 'primeiro', 'Planejamento de eventos do semestre.', 'aprovado', 'Gabriel Pereira', 15),
(17, 'Uso da quadra para Lazer', 'esportivo', 'Futsal', '2025-11-08', 'segundo', 'Solicitação de aluno para jogo com amigos.', 'rejeitado', 'Bruno Rodrigues', 8),
(16, 'Treino de Handebol - VENENOSA', 'esportivo', 'Handebol', '2025-11-08', 'primeiro', 'Treino de ataque e contra-ataque.', 'aprovado', 'Mariana Ferreira', 18),
(6, 'Manutenção da Quadra', 'nao_esportivo', NULL, '2025-11-09', 'primeiro', 'Reserva para manutenção e pintura.', 'aprovado', 'Admin Esportes', 3),
(13, 'Campeonato CS:GO - Semifinal', 'esportivo', 'CS:GO', '2025-11-09', 'segundo', 'Semifinal do campeonato interno.', 'aprovado', 'Pedro Martins', 20),
(12, 'Treino Vôlei de Praia', 'esportivo', 'Vôlei de Praia', '2025-11-10', 'primeiro', 'Treino na quadra externa.', 'aprovado', 'Julia Alves', 12),
(7, 'Palestra: Gestão de Projetos', 'nao_esportivo', NULL, '2025-11-10', 'segundo', 'Palestra para alunos de Engenharia.', 'aprovado', 'Prof. Carlos Andrade', 65),
(11, 'Jogo-Treino Futsal vs INSANA', 'esportivo', 'Futsal', '2025-11-11', 'primeiro', 'Preparação tática para o campeonato.', 'aprovado', 'Lucas Mendes', 30),
(14, 'Workshop de Primeiros Socorros', 'nao_esportivo', NULL, '2025-11-11', 'segundo', 'Capacitação para membros das atléticas.', 'aprovado', 'Fernanda Oliveira', 40),
(18, 'Palestra: Ansiedade e Desempenho', 'nao_esportivo', NULL, '2025-11-12', 'primeiro', 'Evento do curso de Psicologia.', 'aprovado', 'Larissa Gonçalves', 55),
(16, 'Torneio de Handebol - Quartas', 'esportivo', 'Handebol', '2025-11-12', 'segundo', 'Quartas de final do torneio.', 'aprovado', 'Mariana Ferreira', 35),
(9, 'Júri Simulado - Direito', 'nao_esportivo', NULL, '2025-11-13', 'primeiro', 'Atividade prática do curso de Direito.', 'aprovado', 'Prof. Ricardo Souza', 80),
(13, 'Treino League of Legends - ALFA', 'esportivo', 'League of Legends', '2025-11-13', 'segundo', 'Análise de partidas anteriores.', 'aprovado', 'Pedro Martins', 10),
(11, 'Treino Futsal - FURIOSA', 'esportivo', 'Futsal', '2025-11-14', 'primeiro', 'Treino de finalizações.', 'aprovado', 'Lucas Mendes', 18),
(21, 'Aula de Yoga para Atletas', 'esportivo', NULL, '2025-11-14', 'segundo', 'Atividade de relaxamento e alongamento.', 'aprovado', 'Sra. Ana Paula', 25),
(12, 'Seletiva Final Vôlei', 'esportivo', 'Voleibol', '2025-11-15', 'primeiro', 'Definição do time principal.', 'aprovado', 'Julia Alves', 24),
(8, 'Hackathon Universitário', 'nao_esportivo', NULL, '2025-11-15', 'segundo', 'Maratona de programação.', 'aprovado', 'Profa. Beatriz Lima', 50),
(15, 'Evento de Networking', 'nao_esportivo', NULL, '2025-11-16', 'primeiro', 'Conexões para futuros profissionais.', 'pendente', 'Gabriel Pereira', 70),
(14, 'Amistoso Basquete vs LETAL', 'esportivo', 'Basquetebol', '2025-11-16', 'segundo', 'Jogo preparatório.', 'pendente', 'Fernanda Oliveira', 22),
(4, 'Reunião de Coordenadores', 'nao_esportivo', NULL, '2025-11-17', 'primeiro', 'Alinhamento mensal.', 'pendente', 'Admin Atletica Teste', 10),
(11, 'Treino Tático Futsal', 'esportivo', 'Futsal', '2025-11-17', 'segundo', 'Estratégias de jogo.', 'pendente', 'Lucas Mendes', 20),
(16, 'Treino Handebol - VENENOSA', 'esportivo', 'Handebol', '2025-11-18', 'primeiro', 'Treino de defesa.', 'pendente', 'Mariana Ferreira', 16),
(13, 'Final CS:GO', 'esportivo', 'CS:GO', '2025-11-18', 'segundo', 'Grande final do campeonato.', 'pendente', 'Pedro Martins', 30),
(7, 'Semana da Engenharia', 'nao_esportivo', NULL, '2025-11-19', 'primeiro', 'Abertura da semana temática.', 'pendente', 'Prof. Carlos Andrade', 100),
(12, 'Treino Vôlei Feminino', 'esportivo', 'Voleibol', '2025-11-19', 'segundo', 'Preparação para jogos de novembro.', 'pendente', 'Julia Alves', 18),
(11, 'Intercursos - Abertura Futsal', 'esportivo', 'Futsal', '2025-11-20', 'primeiro', 'Jogo de abertura do Intercursos.', 'pendente', 'Lucas Mendes', 50),
(14, 'Intercursos - Basquete Fase 1', 'esportivo', 'Basquetebol', '2025-11-20', 'segundo', 'Primeira fase do torneio.', 'pendente', 'Fernanda Oliveira', 40),
(12, 'Intercursos - Vôlei Fase 1', 'esportivo', 'Voleibol', '2025-11-21', 'primeiro', 'Jogos da primeira fase.', 'pendente', 'Julia Alves', 45),
(16, 'Intercursos - Handebol Fase 1', 'esportivo', 'Handebol', '2025-11-21', 'segundo', 'Início do torneio de handebol.', 'pendente', 'Mariana Ferreira', 38),
(13, 'Intercursos - E-sports LoL', 'esportivo', 'League of Legends', '2025-11-22', 'primeiro', 'Torneio de League of Legends.', 'pendente', 'Pedro Martins', 25),
(11, 'Intercursos - Futsal Quartas', 'esportivo', 'Futsal', '2025-11-22', 'segundo', 'Quartas de final de futsal.', 'pendente', 'Lucas Mendes', 55),
(17, 'Intercursos - Queimada', 'esportivo', 'Queimada', '2025-11-23', 'primeiro', 'Torneio de queimada misto.', 'pendente', 'Bruno Rodrigues', 60),
(12, 'Intercursos - Vôlei Semifinal', 'esportivo', 'Voleibol', '2025-11-23', 'segundo', 'Semifinais de vôlei.', 'pendente', 'Julia Alves', 50),
(20, 'Palestra: Empreendedorismo', 'nao_esportivo', NULL, '2025-11-24', 'primeiro', 'Palestra com empresário local.', 'pendente', 'Sr. Jorge Santos', 85),
(14, 'Intercursos - Basquete Semifinal', 'esportivo', 'Basquetebol', '2025-11-24', 'segundo', 'Semifinais de basquete.', 'pendente', 'Fernanda Oliveira', 48),
(11, 'Intercursos - Futsal Semifinal', 'esportivo', 'Futsal', '2025-11-25', 'primeiro', 'Semifinais de futsal.', 'pendente', 'Lucas Mendes', 60),
(16, 'Intercursos - Handebol Semifinal', 'esportivo', 'Handebol', '2025-11-25', 'segundo', 'Semifinais de handebol.', 'pendente', 'Mariana Ferreira', 42),
(8, 'Workshop: Inteligência Artificial', 'nao_esportivo', NULL, '2025-11-26', 'primeiro', 'Introdução a IA e Machine Learning.', 'pendente', 'Profa. Beatriz Lima', 45),
(12, 'Intercursos - Final Vôlei', 'esportivo', 'Voleibol', '2025-11-26', 'segundo', 'Grande final de vôlei feminino.', 'pendente', 'Julia Alves', 70),
(14, 'Intercursos - Final Basquete', 'esportivo', 'Basquetebol', '2025-11-27', 'primeiro', 'Grande final de basquete.', 'pendente', 'Fernanda Oliveira', 65),
(11, 'Intercursos - Final Futsal', 'esportivo', 'Futsal', '2025-11-27', 'segundo', 'Grande final de futsal masculino.', 'pendente', 'Lucas Mendes', 80),
(16, 'Intercursos - Final Handebol', 'esportivo', 'Handebol', '2025-11-28', 'primeiro', 'Grande final de handebol.', 'pendente', 'Mariana Ferreira', 55),
(6, 'Intercursos - Cerimônia de Encerramento', 'nao_esportivo', NULL, '2025-11-28', 'segundo', 'Premiação e encerramento do Intercursos.', 'pendente', 'Admin Esportes', 150),
(15, 'Feira de Profissões', 'nao_esportivo', NULL, '2025-11-29', 'primeiro', 'Evento para calouros e comunidade.', 'pendente', 'Gabriel Pereira', 120),
(9, 'Seminário de Direito Constitucional', 'nao_esportivo', NULL, '2025-11-29', 'segundo', 'Evento acadêmico do curso.', 'pendente', 'Prof. Ricardo Souza', 75),
(18, 'Workshop: Saúde Mental na Universidade', 'nao_esportivo', NULL, '2025-11-30', 'primeiro', 'Atividade do curso de Psicologia.', 'pendente', 'Larissa Gonçalves', 50),
(11, 'Confraternização FURIOSA', 'nao_esportivo', NULL, '2025-11-30', 'primeiro', 'Evento de confraternização da atlética.', 'pendente', 'Lucas Mendes', 35),
(12, 'Confraternização PREDADORA', 'nao_esportivo', NULL, '2025-12-01', 'segundo', 'Festa de encerramento do semestre.', 'pendente', 'Julia Alves', 40),
(7, 'Última Aula - Formandos Engenharia', 'nao_esportivo', NULL, '2025-12-01', 'primeiro', 'Despedida dos formandos.', 'pendente', 'Prof. Carlos Andrade', 80),
(13, 'Torneio de Xadrez', 'esportivo', 'Xadrez', '2025-12-02', 'segundo', 'Campeonato interno de xadrez.', 'pendente', 'Pedro Martins', 20),
(21, 'Aula Aberta de Meditação', 'nao_esportivo', NULL, '2025-12-02', 'primeiro', 'Técnicas de mindfulness para estudantes.', 'pendente', 'Sra. Ana Paula', 30),
(17, 'Festa de Aniversário na Quadra', 'nao_esportivo', NULL, '2025-12-03', 'segundo', 'Comemoração de aniversário.', 'rejeitado', 'Bruno Rodrigues', 25),
(18, 'Treino Livre de Skate', 'esportivo', NULL, '2025-12-03', 'primeiro', 'Treino de manobras de skate.', 'rejeitado', 'Larissa Gonçalves', 12),
(19, 'Gravação de TikTok', 'nao_esportivo', NULL, '2025-12-04', 'segundo', 'Gravação de vídeos para redes sociais.', 'rejeitado', 'Rafael Almeida', 8),
(20, 'Churrasco da Turma', 'nao_esportivo', NULL, '2025-12-04', 'segundo', 'Confraternização com churrasco.', 'rejeitado', 'Sr. Jorge Santos', 30),
(21, 'Aula Particular de Tênis', 'esportivo', 'Tênis de Campo', '2025-12-05', 'primeiro', 'Professor particular.', 'rejeitado', 'Sra. Ana Paula', 2),
(17, 'Treino de Parkour', 'esportivo', NULL, '2025-12-05', 'segundo', 'Treino de saltos e acrobacias.', 'rejeitado', 'Bruno Rodrigues', 10),
(18, 'Show Acústico', 'nao_esportivo', NULL, '2025-12-06', 'primeiro', 'Apresentação musical.', 'rejeitado', 'Larissa Gonçalves', 40),
(19, 'Treino de Crossfit Externo', 'esportivo', NULL, '2025-12-06', 'primeiro', 'Box de crossfit externo.', 'rejeitado', 'Rafael Almeida', 20),
(11, 'Treino Extra Futsal', 'esportivo', 'Futsal', '2025-12-07', 'primeiro', 'Treino adicional solicitado.', 'rejeitado', 'Lucas Mendes', 18),
(12, 'Amistoso Vôlei Extra', 'esportivo', 'Voleibol', '2025-12-07', 'segundo', 'Jogo amistoso.', 'rejeitado', 'Julia Alves', 24),
(14, 'Campeonato Basquete 3x3', 'esportivo', 'Basquetebol', '2025-12-08', 'primeiro', 'Torneio aberto.', 'rejeitado', 'Fernanda Oliveira', 60),
(15, 'Palestra com Influencer', 'nao_esportivo', NULL, '2025-12-08', 'primeiro', 'Palestra motivacional.', 'rejeitado', 'Gabriel Pereira', 150);
...
(11, 1, '2025-10-20 19:30:00'),
(12, 1, '2025-10-20 19:30:00'),
(13, 1, '2025-10-20 19:30:00'),
(12, 2, '2025-10-20 21:15:00'),
(14, 2, '2025-10-20 21:15:00'),
(16, 2, '2025-10-20 21:15:00'),

-- Agosto 2025 (IDs 10-20 são eventos finalizados)
(11, 10, '2025-10-24 19:20:00'),
(13, 10, '2025-10-24 19:20:00'),
(17, 10, '2025-10-24 19:20:00'),
(12, 11, '2025-10-25 21:15:00'),
(14, 11, '2025-10-25 21:15:00'),
(16, 11, '2025-10-25 21:15:00'),

-- Setembro 2025 (IDs 31-40 são eventos finalizados, exceto o ID 34 que foi cancelado)
(11, 31, '2025-11-04 19:15:00'),
(12, 31, '2025-11-04 19:15:00'),
(11, 32, '2025-11-04 21:20:00'),
(13, 32, '2025-11-04 21:20:00'),
(14, 32, '2025-11-04 21:20:00'),
(12, 36, '2025-11-06 21:15:00'),
(13, 36, '2025-11-06 21:15:00'),
(11, 40, '2025-11-08 21:25:00'),
(13, 40, '2025-11-08 21:25:00'),

-- Outubro 2025 (apenas eventos finalizados até dia 3)
(11, 41, '2025-11-09 19:20:00'),
(13, 41, '2025-11-09 19:20:00'),
(17, 41, '2025-11-09 19:20:00'),
(12, 42, '2025-11-09 21:15:00'),
(14, 42, '2025-11-09 21:15:00'),
(16, 42, '2025-11-09 21:15:00'),

-- Outubro 2025 - Eventos aprovados a partir de 14/10 (com presenças)
-- ID 45: Jogo-Treino Futsal vs INSANA (14/10)
(11, 45, '2025-11-11 19:20:00'),
(13, 45, '2025-11-11 19:25:00'),
(17, 45, '2025-11-11 19:30:00'),
(12, 45, '2025-11-11 19:35:00'),

-- ID 46: Workshop de Primeiros Socorros (15/10)
(14, 46, '2025-11-11 21:15:00'),
(16, 46, '2025-11-11 21:20:00'),
(11, 46, '2025-11-11 21:25:00'),
(12, 46, '2025-11-11 21:30:00'),
(15, 46, '2025-11-11 21:35:00'),

-- ID 47: Palestra Ansiedade e Desempenho (16/10)
(18, 47, '2025-11-12 19:15:00'),
(19, 47, '2025-11-12 19:20:00'),
(15, 47, '2025-11-12 19:25:00'),
(11, 47, '2025-11-12 19:30:00'),

-- ID 48: Torneio de Handebol - Quartas (17/10)
(16, 48, '2025-11-12 21:15:00'),
(14, 48, '2025-11-12 21:20:00'),
(12, 48, '2025-11-12 21:25:00'),
(11, 48, '2025-11-12 21:30:00'),

-- ID 49: Júri Simulado - Direito (18/10)
(12, 49, '2025-11-13 19:15:00'),
(18, 49, '2025-11-13 19:20:00'),
(9, 49, '2025-11-13 19:25:00'),
(15, 49, '2025-11-13 19:30:00'),

-- ID 50: Treino League of Legends - ALFA (19/10)
(13, 50, '2025-11-13 21:15:00'),
(11, 50, '2025-11-13 21:20:00'),
(17, 50, '2025-11-13 21:25:00'),
(19, 50, '2025-11-13 21:30:00'),

-- ID 51: Treino Futsal - FURIOSA (20/10)
(11, 51, '2025-11-14 19:15:00'),
(13, 51, '2025-11-14 19:20:00'),
(17, 51, '2025-11-14 19:25:00'),
(12, 51, '2025-11-14 19:30:00'),

-- ID 52: Aula de Yoga para Atletas (21/10)
(11, 52, '2025-11-14 21:15:00'),
(12, 52, '2025-11-14 21:20:00'),
(14, 52, '2025-11-14 21:25:00'),
(16, 52, '2025-11-14 21:30:00'),
(18, 52, '2025-11-14 21:35:00'),

-- ID 53: Seletiva Final Vôlei (22/10)
(12, 53, '2025-11-15 19:15:00'),
(14, 53, '2025-11-15 19:20:00'),
(16, 53, '2025-11-15 19:25:00'),
(18, 53, '2025-11-15 19:30:00'),

-- ID 54: Hackathon Universitário (23/10)
(11, 54, '2025-11-15 21:15:00'),
(13, 54, '2025-11-15 21:20:00'),
(17, 54, '2025-11-15 21:25:00'),
(19, 54, '2025-11-15 21:30:00'),
(8, 54, '2025-11-15 21:35:00');
...
(11, 'Agendamento Aprovado', 'Seu agendamento "Treino de Férias - Futsal" foi aprovado.', 'agendamento_aprovado', 1, 1, '2025-10-20 10:30:00'),
(12, 'Agendamento Aprovado', 'Seu agendamento "Jogo Amistoso Vôlei" foi aprovado.', 'agendamento_aprovado', 2, 1, '2025-10-20 14:15:00'),
(13, 'Presença Confirmada', 'Sua presença no evento "Treino de Férias - Futsal" foi registrada.', 'presenca_confirmada', 1, 1, '2025-10-20 20:00:00'),

-- Notificações de Setembro
(11, 'Lembrete de Evento', 'Não se esqueça do "Jogo-Treino Futsal vs SANGUINÁRIA" amanhã às 21:10.', 'lembrete_evento', 32, 1, '2025-10-29 18:00:00'),
(12, 'Agendamento Cancelado', 'O evento "Treino Cancelado (Chuva)" foi cancelado devido a problemas técnicos.', 'agendamento_cancelado', 34, 1, '2025-10-31 15:45:00'),
(14, 'Presença Confirmada', 'Sua presença no evento "Amistoso Vôlei vs IMPÉRIO" foi registrada.', 'presenca_confirmada', 36, 1, '2025-11-01 22:55:00'),

-- Notificações Recentes (Outubro)
(11, 'Agendamento Aprovado', 'Seu agendamento "Treino Futsal Masculino - FURIOSA" foi aprovado.', 'agendamento_aprovado', 41, 0, '2025-11-04 08:30:00'),
...
(12, 'Informação', 'Nova política de uso da quadra implementada. Confira as atualizações.', 'info', NULL, 0, '2025-11-01 14:30:00'),
(13, 'Aviso de Manutenção', 'A sala de e-sports ficará fechada para manutenção dia 23/10.', 'aviso', NULL, 0, '2025-11-02 11:45:00'),
(14, 'Lembrete de Documentação', 'Não se esqueça de atualizar seu atestado médico para participar dos treinos.', 'info', NULL, 0, '2025-11-01 10:15:00'),
(15, 'Aviso de Evento', 'As inscrições para o Intercursos 2025 serão abertas em breve.', 'info', NULL, 0, '2025-11-03 08:00:00'),

-- Notificações de Ações em Membros (Exemplos históricos)
(11, 'Bem-vindo à Atlética! 🎉', 'Parabéns! Sua solicitação para se juntar à A.A.A. TOURADA foi aprovada. Agora você é um membro oficial e pode participar das atividades e eventos!', 'info', NULL, 1, '2025-10-20 14:30:00'),
(12, 'Bem-vindo à Atlética! 🎉', 'Parabéns! Sua solicitação para se juntar à A.A.A. RAPOSADA foi aprovada. Agora você é um membro oficial e pode participar das atividades e eventos!', 'info', NULL, 1, '2025-10-22 16:45:00'),
(13, 'Bem-vindo à Atlética! 🎉', 'Parabéns! Sua solicitação para se juntar à A.A.A. ÁGUIAS foi aprovada. Agora você é um membro oficial e pode participar das atividades e eventos!', 'info', NULL, 1, '2025-10-25 10:20:00'),
(4, 'Promoção a Administrador! 🚀', 'Parabéns! Você foi promovido a Administrador da A.A.A. RAPOSADA. Agora você tem permissões especiais para gerenciar membros, eventos e inscrições.', 'info', NULL, 1, '2025-10-28 11:00:00'),
(17, 'Solicitação Não Aprovada 😔', 'Sua solicitação para se juntar à A.A.A. TOURADA não foi aprovada desta vez. Você pode fazer uma nova solicitação no futuro.', 'aviso', NULL, 1, '2025-10-30 15:30:00');
